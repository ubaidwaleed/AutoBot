...
function AutoBot() {
  ...
  const [chatMessages, setChatMessages] = useState([
    {
      sender: "ai",
      message:
        "Hello! I am Autobot, your cars companion! How can i help you today?",
    },
  ]);
  ...
  const sendMessageToGemini = async (message) => {
    ...
    try {
      ...
      console.error("Error sending message to Gemini:", error);
      setIsTyping(false); // Remove typing indicator in case of an error
      return null;
    }
  };
  ...
  const handleSubmit = async () => {
    ...
    const userMessage = { sender: "human", message: value };
